...
PauseMenu::PauseMenu(void) {
	...
	rPause.y = 140 + (540-448)/2; //+vita height/2
	rPause.w = 360;
	rPause.h = 142;

	this->lMO.push_back(new MenuOption("RESUME", 0, 156 + (540-448)/2));
	this->lMO.push_back(new MenuOption("OPTIONS", 0, 180 + (540-448)/2));

	this->lMO.push_back(new MenuOption("QUIT TO MENU", 0, 228 + (540-448)/2));
	this->lMO.push_back(new MenuOption("QUIT GAME", 0, 252 + (540-448)/2));
