...
void AboutMenu::Draw(SDL_Renderer* rR) {
	...
	CCFG::getText()->DrawWS(rR, "AUTHOR: LUKASZ JAKOWSKI", 150, 146, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "PC->VITA->PC PORT V1.00", 150, 188, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "KIRILL PETROV AKA HAMMERILL", 150, 206, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "UKRAINE->FRANCE 2022", 150, 224, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "HTTPS://GITHUB.COM/HAMMERILL", 150, 264, 0, 0, 0);
