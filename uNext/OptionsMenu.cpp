...
OptionsMenu::OptionsMenu(void) {
	...
	this->lMO.push_back(new MenuOption("FULLSCREEN", 73, 233 + halfVitaHeight));
	this->lMO.push_back(new MenuOption("MAIN MENU", 73, 281 + halfVitaHeight));
...
void OptionsMenu::Draw(SDL_Renderer* rR) {
	...
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDA), 185, 89 + halfVitaHeight, 16, activeMenuOption == 1 ? 255 : 90, activeMenuOption == 1 ? 255 : 90, activeMenuOption == 1 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDS), 185, 113 + halfVitaHeight, 16, activeMenuOption == 2 ? 255 : 90, activeMenuOption == 2 ? 255 : 90, activeMenuOption == 2 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDD), 185, 137 + halfVitaHeight, 16, activeMenuOption == 3 ? 255 : 90, activeMenuOption == 3 ? 255 : 90, activeMenuOption == 3 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDSpace), 185, 161 + halfVitaHeight, 16, activeMenuOption == 4 ? 255 : 90, activeMenuOption == 4 ? 255 : 90, activeMenuOption == 4 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDShift), 185, 185 + halfVitaHeight, 16, activeMenuOption == 5 ? 255 : 90, activeMenuOption == 5 ? 255 : 90, activeMenuOption == 5 ? 255 : 90);
	...
	CCFG::getText()->Draw(rR, CCFG::fullscreen ? "ON" : "OFF", 357, 233 + halfVitaHeight, 16, activeMenuOption == 7 ? 255 : 90, activeMenuOption == 7 ? 255 : 90, activeMenuOption == 7 ? 255 : 90);
...
void OptionsMenu::enter() {
	switch(activeMenuOption) {
		...
		case 6:
			...
			break;
		case 7:
			CCFG::fullscreen = !CCFG::fullscreen;
			CCore::setFullscreen(CCFG::fullscreen);
			break;
		case 8:
